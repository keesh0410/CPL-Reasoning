...
def preprocess_pairwise_dataset(
    ...
    for i in range(len(examples["prompt"])):
        ...
        ### [Edited!!!] ###
        if examples.get("q_chosen") is not None and examples.get("q_rejected") is not None:
            if model_inputs.get("q_chosen") is None and model_inputs.get("q_rejected") is None:
                model_inputs["q_chosen"] = []
                model_inputs["q_rejected"] = []
            model_inputs["q_chosen"].append(examples["q_chosen"][i])
            model_inputs["q_rejected"].append(examples["q_rejected"][i])
        ### [Edited!!!] ###
        if processor is not None:
...
def print_pairwise_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
    ...
    ### [Edited!!!] ###
    if example.get("q_chosen") is not None and example.get("q_rejected") is not None:
        print("q_chosen:\n{}".format(example["q_chosen"]))
        print("q_rejected:\n{}".format(example["q_rejected"]))
    ### [Edited!!!] ###
